...
@interface PLHLineChartView ()<ChartViewDelegate>
@property (nonatomic,strong) LineChartView * lineView;
@property (nonatomic,strong) UILabel * markY;

@end

@implementation PLHLineChartView

- (UILabel *)markY{
    if (!_markY) {
        _markY = [[UILabel alloc]initWithFrame:CGRectMake(20, 200, 35, 25)];
...
- (LineChartView *)lineView {
    if (!_lineView) {
        _lineView = [[LineChartView alloc] initWithFrame:CGRectMake(20, 300, 300, 200)];
...
//        leftAxis.valueFormatter = [[SymbolsValueFormatter alloc]init];
        ...
        xAxis.axisLineColor = [UIColor grayColor];
         xAxis.valueFormatter = [[DayAxisValueFormatter alloc] initForChart:_lineView];
